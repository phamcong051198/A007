...
const AppTopBar: React.FC = () => {
  ...
  return (
    <Fragment>
      <div
        className="absolute top-0 right-0 w-full h-[32px]  flex items-center py-[2px] pr-[1px] justify-end  select-none"
      ...
      >
        ...
        >
          <button
            className="w-8 h-8 flex items-center justify-center hover:bg-border-default rounded"
          ...
          <button
            className="w-8 h-8 flex items-center justify-center hover:text-white hover:bg-red-600 rounded"
            onClick={handleClose}
          >
            ✕
          </button>
