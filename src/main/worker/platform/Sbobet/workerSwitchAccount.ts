...
async function switchAccountSbobet() {
  try {
    ...
    setTimeout(switchAccountSbobet, Number(valueSwitch.switchIntervalSettingMinutes) * 60 * 1000)
  } catch (error) {
    console.error('❌ Error in switchAccountIsn88:', error)
  }
}
