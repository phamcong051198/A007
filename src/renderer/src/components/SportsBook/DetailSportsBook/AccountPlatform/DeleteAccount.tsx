...
function DeleteAccount({ deleteAccount }) {
  return (
    <AlertDialog>
      ...
      <AlertDialogContent className="gap-0 p-0 w-[440px] bg-white rounded-lg border-0 shadow-lg overflow-hidden">
          ...
          <div className="flex items-start gap-4">
            ...
            <AlertDialogCancel className="border-none relative bg-transparent hover:bg-transparent focus:ring-0 focus:ring-offset-0 shadow-none">
              <div className="flex justify-between relative ">
                <button
                  type="button"
                  className="absolute top-[-34px] right-[-39px] font-normal block w-8 h-8 leading-none text-[#85888E] hover:bg-gray-200 hover:rounded-full"
                >
                  ✕
                </button>
              </div>
        ...
        <AlertDialogFooter className="flex gap-3 p-6 pt-4">
          <div className="flex-1">
            <AlertDialogCancel className="w-full h-10 rounded-md border border-border-default hover:bg-transparent hover:border-gray-700">
              Cancel
            </AlertDialogCancel>
          </div>
          <div className="flex-1">
            <button
              ...
              className="w-full h-10 text-sm bg-red-600 text-white rounded-md hover:bg-red-700"
            >
              Delete
            </button>
          </div>
