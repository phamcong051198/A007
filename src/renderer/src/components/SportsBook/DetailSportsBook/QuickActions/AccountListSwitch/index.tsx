...
import { Main } from '@renderer/components/SportsBook/DetailSportsBook/QuickActions/AccountListSwitch/Main'

function AccountListSwitch({ sportsBook }: { sportsBook: SportsBookType }) {
          ...
          <header className="flex pt-[16px]">
            ...
            <div className="ml-[16px] flex flex-col">
              <div className="flex justify-between">
                <p className="text-lg font-semibold text-[#F7F7F7]"> Account List Switch</p>
                <button
