...
const TargetBetTo = ({
  ...
  const [dataBetTo, setDataBetTo] = useState<BetToType>(() => {
    return dataTarget[typeAccount][`${keyCurrent}_Detail`].betTo || {}
  })
  ...
  return (
    <div className="absolute w-[400px] h-[350px] right-1 bottom-4 bg-layout-color z-[60] border border-gray-400 flex  flex-col shadow-2xl">
      <p
...
export default React.memo(TargetBetTo)
